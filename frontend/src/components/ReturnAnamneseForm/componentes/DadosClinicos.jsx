        ...
        <div className="d-flex align-items-center gap-1 form-check">
          ...
          <label className="form-check-label ms-1" htmlFor="flatulencia_nao">Não</label>
                ...
                <div className="d-flex align-items-center gap-1 form-check">
                    ...
                    />
                    <label className="form-check-label ms-1" htmlFor="sono_bom">Bom</label>
                </div>
                ...
                <div className="d-flex align-items-center gap-1 form-check">
                    ...
                    onClick={() => toggleField("sono")}
                    />
                    <label className="form-check-label ms-1" htmlFor="sono_mediano">Mediano</label>
                </div>
                    ...
                    <input
                        ...
                        onClick={() => toggleField("sono")}
                    />
                    <label className="form check-label ms-1" htmlFor="sono_ruim">Ruim</label>
                    </div>
                            <div className="d-flex align-items-center gap-2 ms-3">
