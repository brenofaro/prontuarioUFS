...
const BioquimicaChild = ({formData, setFormData}) => {
 ...
 const handleChange = (e) => {
  ...
  <div className="d-flex flex-column mb-3" style={{ maxWidth: "250px" }}>
    <label className="form-label text-muted small" htmlFor="data_ab">Data da Avaliação</label>
    <input
      type="date"
      id="data_ab"
      name="data_ab"
...
export default BioquimicaChild
