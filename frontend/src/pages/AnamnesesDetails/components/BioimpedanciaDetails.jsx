        ...
        <div className="row g-3 mb-4 ps-1">
          ...
          <div className="col-md-3">
            <div className="flex-grow-1">
              ...
              <span className="fw-medium">{anamnese.peso_gordura || "-"}</span>
            </div>
          </div>
          <div className="col-md-3">
            <div className="flex-grow-1">
              <small className="text-muted d-block">Massa magra:</small>
              <span className="fw-medium">{anamnese.massa_magra || "-"}</span>
            </div>
          </div>
          <div className="col-md-3">
            <div className="flex-grow-1">
          ...
          <div className="col-md-3">
            <div className="flex-grow-1">
              ...
              <span className="fw-medium">{anamnese.peso_alvo || "-"}</span>
            </div>
          </div>
          <div className="col-md-3">
            <div className="flex-grow-1">
          ...
          <div className="col-md-3">
            <div className="flex-grow-1">
              ...
              <span className="fw-medium">
                {anamnese.percentual_agua_massa_magra || "-"}
              </span>
            </div>
          </div>
          <div className="col-md-3">
