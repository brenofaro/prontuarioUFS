...
const SaudeChildDetails = ({anamnese}) => {
   const booleanLabels = {
          true: "Sim",
          false: "Não",
      };
        ...
        <div>
          ...
          <div className="p-3 bg-light rounded border-start border-secondary border-3">
            <p className="mb-0 text-dark" style={{ whiteSpace: 'pre-wrap', lineHeight: '1.6', fontFamily: "arial" }}>
              {anamnese.objetivo_consulta || <span className="text-muted fst-italic">Não informado</span>}
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="p-3 bg-light rounded border-start border-success border-3">
            <p className="mb-0 text-dark" style={{ whiteSpace: 'pre-wrap', lineHeight: '1.6' , fontFamily:"sans-serif"}}>
              {anamnese.historia_doenca || <span className="text-muted fst-italic">Não informado</span>}
            </p>
          </div>
        </div>
        <div className="mb-2">
...
{/* <h6 className="text-muted fw-semibold mb-2 small text-uppercase">
  ...
  <div className="table-responsive">
    <table className="table table-bordered table-hover align-middle">
      ...
      <tbody>
        ...
        {(anamnese.hipertencao_hma || anamnese.hipertencao_hf) && (
          <tr>
            <td>Hipertensão</td>
            <td className="text-center">
        ...
        {(anamnese.doenca_cardiovascular_hma || anamnese.doenca_cardiovascular_hf) && (
          <tr>
        ...
        {(anamnese.dislipidemia_hma || anamnese.dislipidemia_hf) && (
          <tr>
            <td>Dislipidemia</td>
            <td className='text-center'>
        ...
        {(anamnese.osteoporose_hma || anamnese.osteoporose_hf) && (
          <tr>
            <td>Osteoporose</td>
            <td className='text-center'>
        ...
        {(anamnese.parasitoses_hma || anamnese.parasitoses_hf) && (
          <tr>
            <td>Parasitoses</td>
            <td className='text-center'>
        ...
        {(anamnese.drge_hma || anamnese.drge_hf) && (
          <tr>
            <td>DRGE</td>
            <td className='text-center'>
              {anamnese.drge_hma ? (
  ...
  <div>
          ...
          <div className="p-3 bg-light rounded border-start border-success border-3">
            <p className="mb-0 text-dark" style={{ whiteSpace: 'pre-wrap', lineHeight: '1.6' , fontFamily:"sans-serif"}}>
              {anamnese.outras_patologias || <span className="text-muted fst-italic">Não informado</span>}
            </p>
          </div>
        </div>
    ...
    <div className="bg-light rounded-3 p-3">
      <div className="d-flex align-items-center mb-3">
        ...
        <span className={`badge ${anamnese.faz_uso_medicamentos ? 'bg-success' : 'bg-secondary'}`}>
      ...
      {anamnese.faz_uso_medicamentos === true && (
        <div className="ms-4 border-start border-2 border-success ps-3">
          <div className="mb-2">
            ...
            <span className="fw-medium" style={{fontFamily:"arial"}}>{anamnese.medicamentos || "-"}</span>
          </div>
...
export default SaudeChildDetails
