        ...
        <div className="mb-5">
          ...
          <div className="bg-white rounded-3 p-3">
            <div className="d-flex align-items-center mb-3">
              ...
              <span className={`badge ${anamnese.escolar ? 'bg-success' : 'bg-secondary'}`}>
            ...
            {anamnese.escolar === true && (
              <div className="ms-4 border-start border-2 border-success ps-3">
                <div className="mb-2">
                  ...
                  <span className="fw-medium">{anamnese.serie_escolar || "-"}</span>
                </div>
                <div>
                  <small className="text-muted d-block">Turno</small>
                  <span className="fw-medium">{anamnese.turno_escolar || "-"}</span>
                </div>
              </div>
            )}
          ...
          <div className="col-md-4">
              <div className="d-flex align-items-start">
                ...
                <div className="flex-grow-1">
                  <small className="text-muted d-block">Adaptação Escolar</small>
                  <span className="fw-medium">{booleanLabels[anamnese.adaptacao_escolar] || "-"}</span>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="d-flex align-items-start">
                ...
                <div className="flex-grow-1">
                  ...
                  <span className="fw-medium">{booleanLabels[anamnese.merenda_escolar] || "-"}</span>
                </div>
              </div>
            </div>            
  ...
  <div className="row">
    ...
    <div className="col-md-4">
              ...
              <div className="d-flex align-items-start">
                {/* <i className="bi bi-briefcase text-muted me-2 mt-1"></i> */}
                <div className="flex-grow-1">
                  <small className="text-muted d-block">Ocupação da responsável</small>
                  <span className="fw-medium">{anamnese.ocupacao_responsavel || "-"}</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="d-flex align-items-start">
                <div className="flex-grow-1">
                  ...
                  <span className="fw-medium">{anamnese.crianca_ativa || "-"}</span>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="d-flex align-items-start">
                <div className="flex-grow-1">
                  ...
                  <span className="fw-medium">{anamnese.horario_dorme || "-"}h</span>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="d-flex align-items-start">
                <div className="flex-grow-1">
                  ...
                  <span className="fw-medium">{anamnese.horario_acorda || "-"}h</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-md-4">
          ...
          <div className="bg-white rounded-3 p-3">
            ...
            <div className="d-flex align-items-center mt-3">
              ...
              <span className={`badge ${anamnese.ja_fez_atividade_fisica ? 'bg-success' : 'bg-secondary'}`}>
