...
const BioquimicaChildDetails = ({anamnese}) => {
        ...
        <Card.Title className='mb-4 border-bottom pb-2' style={{fontFamily:"arial"}}>
            Avaliação Bioquímica:
                ...
                <div className="flex-grow-1 mb-3 ps-1">
                    <small className="text-muted d-block">Data da Avaliação Bioquímica:</small>
                ...
                <div>
                    ...
                    <div className="p-3 bg-light rounded border-start border-success border-3">
                        ...
                        {anamnese.avaliacao_bioquimica || <span className="text-muted fst-italic">Não informado</span>}
                        </p>
                    </div>
                </div>
...
export default BioquimicaChildDetails
